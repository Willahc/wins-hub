    ...
    with conn.cursor() as cur:
        try:
            ...
            try:
                ...
                _ws = None
            obras_para_inserir = _pt.filtrar_e_enriquecer(obras_para_inserir, "ibama_sislic", conn, web_search_fn=_ws, log=log)
    ...
    try:
        ...
        for _obra in obras_para_inserir:
            try:
                ...
                _fonte = _payload.get("fonte") or 'ibama_sislic' or "desconhecida"
                if _id_ext:
                    notificar_master_v2(
                        fonte=_fonte,
                        captador="captar_ibama",
