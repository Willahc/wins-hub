...
def main():
    ...
    try:
        ...
        _cols = ['id_externo', 'nome', 'empresa', 'cnpj', 'setor', 'municipio', 'uf', 'valor_estimado', 'valor_formatado', 'fase', 'status_licenca', 'urgencia', 'lead_score', 'necessidades', 'descricao', 'fonte', 'url_fonte', 'data_publicacao']
        for _obra in obras:
            try:
                ...
                _fonte = _payload.get("fonte") or "antaq"
                if _id_ext:
                    notificar_master_v2(
                        fonte=_fonte,
                        captador="captar_antaq",
